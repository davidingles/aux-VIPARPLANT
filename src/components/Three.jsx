...
const Models = [
  ...
  { title: 'VIPARPLANT', url: './VIPARPLANT.glb', miEscala: .4, miPosicion: -.3 },
  // { title: 'ADIANO1', url: './ADIANO1.glb', miEscala: 2, miPosicion: .2 },
  ...
  return (
    <>
      <Canvas camera={{ position: [0, .4, -0.6], near: .01, fov: 50 }}>
        <pointLight position={[100, 100, 0]} intensity={1} decay={2} />
        <pointLight position={[-100, 100, 0]} intensity={1} decay={2} />
